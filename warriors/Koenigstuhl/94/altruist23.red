...
; Will accept a Win/Loss series, which is fair, and is prepared to die to
; maintain harmony. This helps the other more than myself, but results in
; 150-150 scores in "fights" with other altruists.
...
JumpVec JMP     @0,    PapAdd        
        DJN.a   #100,  #0      ; It is polite to permit slower P-brains  
        DAT     0,     Count   ; to complete their analysis :-)

;redcode-94
;name Cooperative Black Dimension 1.0
;author Blake Escritt/C. Schmidt
;strategy Handshake -> qscanner -> stone/paper
;strategy 1.0: Original program
;strategy Borrowing some code, testing the idea
;strategy of cooperative hill configurations.
;assert 1
...
;r edcode-94nop
;n ame Spiritual Black Dimension
;a uthor Christian Schmidt
;s trategy
;a ssert 1
